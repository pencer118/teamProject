               ...
               <table class="type09" width="500" align="center"  cellpadding="5" cellspacing="0">
                  ...
                  <tr>
                     ...
                     <td colspan="3" align="center">
                        ...
                        <input type="button" class="btn btn-info" value="삭제하기" onclick="location.href='delete?idx=${vo.idx}&currentPage=${currentPage}'"/>
                        <input type="button"  class="btn btn-info" value="돌아가기" onclick="location.href='list?currentPage=${currentPage}'"/>
                     </td>
                  </tr>
               </table>
               </form>
