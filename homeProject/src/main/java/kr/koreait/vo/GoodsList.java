...
public class GoodsList {
	...
	public ArrayList<GoodsVO> getGoodList() {
		return goodList;
	}

	public void setGoodList(ArrayList<GoodsVO> goodList) {
	...
	public String toString() {
		return "GoodsList [goodList=" + goodList + ", pageSize=" + pageSize + ", totalCount=" + totalCount
